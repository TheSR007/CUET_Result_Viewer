...
document.getElementById('cuet-result-viewer').setAttribute('data-theme', systemTheme);

window.matchMedia('(prefers-color-scheme: dark)').addEventListener('change', (e) => {
  const newTheme = e.matches ? 'dark' : 'light';
  document.getElementById('cuet-result-viewer').setAttribute('data-theme', newTheme);
});
...
function createCalculateButton() {
    ...
    button.addEventListener('click', async () => {
        if (document.body.innerHTML.includes('Sorry, no Course result published yet')){
